...
El archivo 003 Monedas.ipynb contiene ejercicios prácticos y explicaciones teóricas sobre los siguientes temas: Detección, segmentación
y análisis de monedas en una imagen mediante técnicas de umbral y etiquetado. Se estudia cómo separar objetos del fondo y contar 
elementos similares usando OpenCV o funciones de procesamiento de imágenes en escala de grises.
...
Ejercicios de análisis y procesamiento de imágenes reales o simuladas.
 ...
 Cómo usarlo
Abrí el archivo en Google Colab o Jupyter Notebook.
Ejecutá las celdas en orden.
Leé los comentarios y modificá el código para experimentar.

👤 Autoría
Autor/a: Elisabeth Pose
Año: 2025
